...
const floorDisplacememtTexture = textureLoader.load('./floor/coast_sand_rocks_02_1k/coast_sand_rocks_02_disp_1k.webp')
...
floorDisplacememtTexture.repeat.set(8, 8)

floorColorTexture.wrapS = THREE.RepeatWrapping
floorARMTexture.wrapS = THREE.RepeatWrapping
floorNormalTexture.wrapS = THREE.RepeatWrapping
floorDisplacememtTexture.wrapS = THREE.RepeatWrapping

floorColorTexture.wrapT = THREE.RepeatWrapping
floorARMTexture.wrapT = THREE.RepeatWrapping
floorNormalTexture.wrapT = THREE.RepeatWrapping
floorDisplacememtTexture.wrapT = THREE.RepeatWrapping
...
const floor = new THREE.Mesh(
    ...
    new THREE.MeshStandardMaterial({
        ...
        displacementMap: floorDisplacememtTexture,
...
for(let i = 0; i < 30; i++)
{
    ...
    const radius = 3 + Math.random() * 4 // Random radius
